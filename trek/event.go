...
// ChamTimes содержит информацию об одном событии КТУДК
type Event struct {
	nRun   uint64
	nEvent uint64
	time   time.Time
...
//Unmarshal осуществляет сериализацию данных события в w
...
//Unmarshal осуществляет десериализацию данных события в r
